...
def compileModules():
    ...
    # 创建软连接
    libraryPath = ["../thirdparty/lib/linux64/Qt", "../thirdparty/lib/linux64/gperftools", "../thirdparty/lib/linux64/ffmpeg", "../thirdparty/lib/linux64/openCV", "../thirdparty/lib/linux64/cryptopp", "../thirdparty/lib/linux64/WeiYuan"]
