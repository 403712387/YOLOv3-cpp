...
DARKNET_EXPORT metadata get_metadata(char *file);
...
DARKNET_EXPORT tree *read_tree(char *filename);
...
DARKNET_EXPORT void free_layer(layer);
...
DARKNET_EXPORT int getGpuIndex();
DARKNET_EXPORT void setGpuIndex(int index);
...
DARKNET_EXPORT void normalize_image2(image p);
